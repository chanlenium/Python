...
def appendDf(cutoffYYYYMM):
    ...
    additionalCommon = lib.pd.read_excel(f'../COMMON_DB/additionalCommon.xlsx')
    ...
    additionalExportImport = lib.pd.read_excel(f'../COMMON_DB/additionalExportImport.xlsx')
    ...
    additionalCommon_IT_EFAS_COMMON_DB.to_excel(f'../COMMON_DB/additionalCommon_IT_EFAS_COMMON_DB.xlsx')
    ...
    IT_EFAS_INDU_COMMON_DB = lib.pd.read_excel(f'../COMMON_DB/IT_EFAS_INDU_COMMON_DB.xlsx')
    ...
    updatedIT_EFAS_INDU_COMMON_DB.to_excel(f'../COMMON_DB/{today}_updatedIT_EFAS_INDU_COMMON_DB.xlsx', index=False)
